...
val launchIntent = getPackageManager().getLaunchIntentForPackage("com.tuffygo.driver");
if (launchIntent != null) { 
    startActivity(launchIntent);//null pointer check in case com.tuffygo.driver was not found
}   }
