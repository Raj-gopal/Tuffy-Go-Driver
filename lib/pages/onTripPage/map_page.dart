                                                                                                    ...
                                                                                                    setState(() {
                                                                                                      bidText.text = (bidText.text.isEmpty)
                                                                                                          ? (choosenRide[0]['price'].toString().contains('.'))
                                                                                                              ? (double.parse(choosenRide[0]['price'].toString()) - 10).toStringAsFixed(2)
                                                                                                              : (int.parse(choosenRide[0]['price'].toString()) - 10).toString()
                                                                                                          : (bidText.text.toString().contains('.'))
                                                                                                              ? (double.parse(bidText.text.toString()) - 10).toStringAsFixed(2)
                                                                                                              : (int.parse(bidText.text.toString()) - 10).toString();
                                                                                                    });
                                                                                                  }
                                                                                                },
                                                                                                child: Container(
                                                                                                              ...
                                                                                                              child: Padding(
                                                                                                                ...
                                                                                                                child: Column(
                                                                                                                  ...
                                                                                                                  FutureBuilder<DataSnapshot>(
                                                                                                                    future: FirebaseDatabase.instance.ref('requests').child('note').child('note').get(),
                                                                                                                    builder: (context, snapshot) {
                                                                                                                      if (snapshot.connectionState == ConnectionState.waiting) {
                                                                                                                        return CircularProgressIndicator();
                                                                                                                      } else if (snapshot.hasError) {
                                                                                                                        return Text('Error: ${snapshot.error}', style: TextStyle(fontSize: 16.0, color: Colors.red));
                                                                                                                      } else if (snapshot.hasData && snapshot.data!.value != null) {
                                                                                                                        // Check the type of data to ensure it's a Map or any other expected format
                                                                                                                        if (snapshot.data!.value is Map) {
                                                                                                                          Map<String, dynamic> data = Map<String, dynamic>.from(snapshot.data!.value as Map);
                                                                                                                          return Text(
                                                                                                                            data.toString(), // Adjust this based on the specific data you want to display
                                                                                                                            style: TextStyle(
                                                                                                                              fontSize: 16.0,
                                                                                                                        ...
                                                                                                                        return Text('No data available', style: TextStyle(fontSize: 16.0, color: Colors.white));
                                                                                                                      }
                                                                                                                    },
                                                                                                                  ),
