...
import 'package:flutter_driver/pages/login/requiredinformation.dart';
              ...
              builder: (context, value, child) {
                return Stack(
                  children: [
                    ...
                    //                   // child:AnimatedSwitcher(duration: Duration(microseconds: 100),child: Image.asset(images[currentPage],height: media.height*0.6,width: media.width,fit: BoxFit.cover,),)
                    //                   child: images[currentPage]),
                    //               // child: Image.asset('assets/images/landingone.png',height: media.height*0.7,width: media.width,fit: BoxFit.cover,),
                    //             ),
                    //             SizedBox(
