...
//base url
String url = 'https://tuffygo.com/'; //add '/' at the end of the url as 'https://url.com/'
String mapkey = Platform.isAndroid ? 'AIzaSyCSmEKEP17uxA-AT1lyTOx7oXUKlNHBlhI' : 'ios map key';
String mapStyle = '';
String mapType = '';
...
geolocs.LocationSettings locationSettings = (platform == TargetPlatform.android)
    ? geolocs.AndroidSettings(
        ...
        foregroundNotificationConfig:
          ...
          notificationText:
              "TuffyGo Driver will continue to receive your location in background",
